const filterSliderData = (data) =>{
  ...
  const filterUserData = (data)=>{
      ...
      const { id, username, name, twitter_username, portfolio_url, bio, links : { html : unsplash_page}, profile_image : { medium : profile_image}, instagram_username } = data;
      return { id, username, name, twitter_username, portfolio_url, bio, unsplash_page, profile_image, instagram_username };
